export const projectDetails = {
  ticketone: {
    ...
    challengeText:
      'Rendere l’accesso agli eventi live semplice, immediato e sicuro, offrendo agli utenti un’esperienza di acquisto chiara e affidabile.',
    processSteps: [
      {
        number: 1,
        title: 'Analisi UX',
      ...
      { number: 2, title: 'Wireframing', description: 'Progettazione wireframe.' },
      {
        number: 3,
        title: 'UI Design',
        description: 'Progettazione e prototipazione dell’interfaccia utente.',
      },
      { number: 4, title: 'User Test', description: 'Test di usabilità e iterazione.' },
    ],
    projectImages: [
      'assets/img//projects/ticketone/project_1.webp',
      'assets/img/projects/ticketone/project_2.webp',
      'assets/img/projects/ticketone/project_3.webp',
    ],
    results: [
  ...
  ivegan: {
    ...
    processSteps: [
      {
        ...
        title: 'Discovery',
        description:
          'Analisi del sito e dei competitor, definizione di utenti e journey, ridefinizione di architettura e flussi.',
      },
      {
        number: 2,
        title: 'Accessibilità',
    ...
    projectImages: [
      'assets/img/projects/ivegan/project_1.webp',
      'assets/img/projects/ivegan/project_2.webp',
      'assets/img/projects/ivegan/project_3.webp',
    ],
    results: [
  ...
  orizon: {
    ...
    processSteps: [
      { number: 1, title: 'Analisi', description: 'Studio del target e dei competitor.' },
      {
        number: 2,
        title: 'Design',
        description: 'Realizzazione logo, icone, font e color palette.',
      },
      {
        number: 3,
        title: 'Comunicazione',
        description: 'Realizzazione di banner social per diversi dispositivi.',
      },
    ],
    projectImages: [
      'assets/img/projects/orizon/project_1.webp',
      'assets/img/projects/orizon/project_2.webp',
      'assets/img/projects/orizon/project_3.webp',
    ],
    results: [
